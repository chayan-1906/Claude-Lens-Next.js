import {IBaseResponse} from "@/types/common.types";
...
export type TSearchItem = ISearchMessageResponse | ISearchSessionResponse | ISearchTaskResponse | ISearchMemoryResponse;
